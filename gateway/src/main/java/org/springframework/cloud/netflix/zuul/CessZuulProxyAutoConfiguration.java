...
//
//import io.cess.gateway.config.CessProxyRequestHelper;
//import io.cess.gateway.config.ZuulExtProperties;
...
//@ConditionalOnBean(CessZuulProxyMarkerConfiguration.Marker.class)
//public class CessZuulProxyAutoConfiguration extends ZuulServerAutoConfiguration {
//
...
//
//	@Configuration
//	@ConditionaalOnMissingClass("org.springframework.boot.actuate.endpoint.Endpoint")
...
//		}
//		@Bean
//		public ProxyRequestHelper proxyRequestHelper(ZuulProperties zuulProperties,ZuulExtProperties extProperties) {
//			ProxyRequestHelper helper = new CessProxyRequestHelper(extProperties);
