...
//public class CloudEjb3Configuration extends org.hibernate.ejb.Ejb3Configuration implements Serializable, Referenceable {
//
//    /**
//	 * 
//	 */
...
//			CloudEjb3Configuration.class.getName()
//	);
...
//	public CloudEjb3Configuration configure(PersistenceMetadata metadata, Map overridesIn) {
...
//	
//	@SuppressWarnings({ "rawtypes", "unchecked" })
//	public CloudEjb3Configuration configure(String persistenceUnitName, Map integration) {
//		try {
...
//								fileSeparator = "/";
//							}
//							String libDirString = file.getParent()+fileSeparator+"lib"+fileSeparator;
//							libDirString = URLDecoder.decode(libDirString, "utf-8");
//							File libDir = new File(libDirString);
//							
//							
//							Set<String> jarPatterns = metadata.getJarFiles();
//							if(libDir.exists() && libDir.isDirectory() && jarPatterns!=null && jarPatterns.size() > 0){
//								
//								File[] jars = libDir.listFiles();
//								if(jars !=null && jars.length > 0){
//									String[] jarPatternStrings = jarPatterns.toArray(new String[]{});
//									Pattern[] ps = new Pattern[jarPatterns.size()];
//									for ( int n=0;n<ps.length ;n++){
//										ps[n] = Pattern.compile(jarPatternStrings[n]);
//									}
//									for(File jar:jars){
//										for ( Pattern p : ps) {
//											if(p.matcher(jar.getName()).matches()){
//												otherJarScanCtx.url(jar.toURI().toURL() );
...
//	public CloudEjb3Configuration configure(PersistenceUnitInfo info, Map integration) {
...
//			
//			try {
//				File file = new File("D:\\jboss-as-7.1.0.Final\\standalone\\deployments\\web.war\\WEB-INF\\lib\\ad.system.jar");
...
//	}
//
//	public CloudEjb3Configuration setProperty(String key, String value) {
...
//						sessionInterceptorClassname, CloudEjb3Configuration.class
//				);
...
//
//	@SuppressWarnings( {"unchecked", "rawtypes"})
//	public CloudEjb3Configuration configure(Map configValues) {
//		Properties props = new Properties();
...
//	 */
//	@SuppressWarnings("rawtypes")
//	private CloudEjb3Configuration configure(Properties properties, Map workingVars) {
...
//			CloudEjb3Configuration cfg, Collection<String> classNames, Map workingVars
//	) {
...
//	}
//
//	public CloudEjb3Configuration addProperties(Properties props) {
//		cfg.addProperties( props );
//		return this;
//	}
//
//	@SuppressWarnings("rawtypes")
//	public CloudEjb3Configuration addAnnotatedClass(Class persistentClass) throws MappingException {
//		Thread thread = null;
//		ClassLoader contextClassLoader = null;
//		if (overridenClassLoader != null) {
//			thread = Thread.currentThread();
...
//	}
//
//	public CloudEjb3Configuration configure(String resource) throws HibernateException {
...
//	}
//
//	public CloudEjb3Configuration addPackage(String packageName) throws MappingException {
//		Thread thread = null;
//		ClassLoader contextClassLoader = null;
//		if (overridenClassLoader != null) {
//			thread = Thread.currentThread();
...
//	}
//
//	public CloudEjb3Configuration addFile(String xmlFile) throws MappingException {
//		Thread thread = null;
//		ClassLoader contextClassLoader = null;
//		if (overridenClassLoader != null) {
//			thread = Thread.currentThread();
...
//
//	@SuppressWarnings("rawtypes")
//	public CloudEjb3Configuration addClass(Class persistentClass) throws MappingException {
//		Thread thread = null;
//		ClassLoader contextClassLoader = null;
//		if (overridenClassLoader != null) {
//			thread = Thread.currentThread();
...
//	}
//
//	public CloudEjb3Configuration addFile(File xmlFile) throws MappingException {
//		Thread thread = null;
//		ClassLoader contextClassLoader = null;
//		if (overridenClassLoader != null) {
//			thread = Thread.currentThread();
...
//	}
//
//	public CloudEjb3Configuration setInterceptor(Interceptor interceptor) {
//		cfg.setInterceptor( interceptor );
//		return this;
//	}
//
//	public CloudEjb3Configuration setProperties(Properties properties) {
...
//	}
//
//	public CloudEjb3Configuration setNamingStrategy(NamingStrategy namingStrategy) {
//		cfg.setNamingStrategy( namingStrategy );
//		return this;
//	}
//
//	public CloudEjb3Configuration setSessionFactoryObserver(SessionFactoryObserver observer) {
//		cfg.setSessionFactoryObserver( observer );
//		return this;
//	}
//
...
//	}
//
//	public CloudEjb3Configuration addInputStream(InputStream xmlInputStream) throws MappingException {
//		Thread thread = null;
//		ClassLoader contextClassLoader = null;
//		if (overridenClassLoader != null) {
//			thread = Thread.currentThread();
...
//	}
//
//	public CloudEjb3Configuration addResource(String path) throws MappingException {
//		Thread thread = null;
//		ClassLoader contextClassLoader = null;
//		if (overridenClassLoader != null) {
//			thread = Thread.currentThread();
...
//	}
//
//	public CloudEjb3Configuration addResource(String path, ClassLoader classLoader) throws MappingException {
