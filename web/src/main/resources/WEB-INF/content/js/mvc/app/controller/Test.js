Ext.define('AD.Web.Test.controller.Test', {
    ...
    init:function(){
    	AD.Context.onPropertyChanged(function(name,value){
    		alert("AD.Context.onPropertyChanged:"+name+":"+value);
    	});
...
//    	});
    ...
    formTest:function(){
    	var content = Ext.widget('form.view');
