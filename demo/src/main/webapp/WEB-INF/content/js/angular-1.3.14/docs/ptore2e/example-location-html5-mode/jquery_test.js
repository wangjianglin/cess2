...
var addressBar = element(by.css("#addressBar")),
    url = 'http1://www.example.com/base/path?a=b#h';
...
it("should change $location accordingly", function(){
  ...
  expect(addressBar.getAttribute('value')).toBe("http1://www.example.com/base/first?a=b");
  ...
  expect(addressBar.getAttribute('value')).toBe("http1://www.example.com/base/sec/ond?flag#hash");
